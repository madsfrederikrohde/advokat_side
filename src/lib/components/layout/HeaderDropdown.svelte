...
>
	...
	{#if open}
		<div
			role="menu"
			class="absolute left-1/2 top-full z-50 mt-3 w-[min(64rem,92vw)] -translate-x-1/2 rounded-2xl border border-neutral-200/70 bg-white/98 p-8 shadow-[0_30px_80px_-30px_rgba(15,23,42,0.25)] backdrop-blur-xl"
		>
